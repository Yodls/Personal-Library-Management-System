...
2: Searches for books. You must choose if you want to search by title, author, or genre, then type in the title, author, or genre to search.

3: Updates a book. You must first identify the book id by listing all books( option 5), and then select id for update. You can then choose to edit the fields one by one, or leave them as is if you dont want to update anything.

4: Removes a book by book id.

5: Displays all stored books.

6: Display books by criteira, option a shows books that have been recently added (lists books from most recently added), and option b lists the books by genre.
